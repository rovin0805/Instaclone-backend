/*
  ...
  - You are about to drop the column `hash` on the `Hashtag` table. All the data in the column will be lost.
...
*/
-- DropIndex
DROP INDEX "Hashtag.hash_unique";

-- AlterTable
ALTER TABLE "Hashtag" DROP COLUMN "hash",
